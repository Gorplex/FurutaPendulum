...
#include "sdio_defines.h"          // Custom stuff for this project
...
///////////////////////////////////////////////////////////////////////////////
inline DSTATUS disk_initialize (BYTE pdrv)
{
	return (TM_FATFS_SD_SDIO_disk_initialize ());
}

inline DSTATUS disk_status (BYTE pdrv)
{
	return (TM_FATFS_SD_SDIO_disk_status ());
}

inline DRESULT disk_read (BYTE pdrv, BYTE *buff, DWORD sector, UINT count)
{
	return TM_FATFS_SD_SDIO_disk_read (buff, sector, count);
}

#if _USE_WRITE
inline DRESULT disk_write (BYTE pdrv, const BYTE *buff, DWORD sector, UINT count)
{
...
#if _USE_IOCTL
inline DRESULT disk_ioctl (BYTE pdrv, BYTE cmd, void *buff)
{
